...
```{r homework 1}
setwd("E:/R4Psy")
Q1 <- bruceR::import("data/penguin/penguin_rawdata.csv")
```
...
```{r homework 4}
Q4 <- mutate(Q3, health = factor(health,
                                 levels = c(1, 2, 3, 4, 5),
...
Q9 <- mutate(Q5 , across(everything(), ~ str_sub(., 1, 1)))
```
